...
router.route('/admin')
     .get(auth_controller.isSupervisor,
          dashboard_user_controller.getUser)

     .post(auth_controller.isAdmin,
          dashboard_user_controller.addUser)
    
     .put(auth_controller.isAdmin,
          dashboard_user_controller.updateUser)
     .delete(auth_controller.isAdmin,
          dashboard_user_controller.deleteUser)
